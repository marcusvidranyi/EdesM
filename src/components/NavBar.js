    ...
    return (
        <nav className="navbar-parent">
            <ul className={scrollPosition < 10 ? "navbar" : "nav_scrolled"}>
                ...
                <li className="navbar-items">
                    <Link to="products" spy={true} smooth={true} offset={-100} duration={500}>Kínálatun<span className="lastletter">K</span></Link>
                </li>
                ...
                <li className="navbar-items">
                    <Link to="aboutus" spy={true} smooth={true} offset={-100} duration={500}>Rólun<span className="lastletter">K</span></Link>
                </li>
                <li className="navbar-items">
